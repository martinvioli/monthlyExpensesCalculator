	...
	return (
		<PurchasesProvider>
			<div style={{ display: 'flex', width: '100%', height: '100%', backgroundColor: 'whitesmoke', gap: '5%', padding: '1.2rem' }}>
				<div style={{ overflowY: 'auto', height: '100%', width: '50%', maxWidth: '50%', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
					<Button style={{minHeight: '2.5rem'}} color="primary" onPress={() => setIsMPOpen(true)}>Agregar compra común</Button>
